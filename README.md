...
Open `/test.html` after starting or deploying the app. The page displays one
shared in-memory number and an increment button.
...
Then open the local Vercel URL printed by the command and visit `/test.html`.
